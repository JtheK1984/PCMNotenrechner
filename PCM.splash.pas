...
begin
  ...
  dm_PCM.int_NotenRight:= dm_PCM.qry_work.FieldByName('Noten').asInteger;
  ...
  case dm_PCM.int_NotenRight of
  0: frm_PCm_Main.nb_Notenverwaltung.Visible:= false;
  1,2,3:
    begin
      frm_PCm_Main.nb_Notenverwaltung.Visible:= true;
      frm_PCm_Main.iNotenuebersicht.Visible:= true;
    end;
  end;
end;
