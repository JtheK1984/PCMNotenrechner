...
msbuild E:/Projekte/Windows/PCMNotenrechner/PCMNotenrechner.dproj /t:Clean;Build;CompressWin32 /p:config=Release /p:platform=Win32
...
call "E:\Inno\Setupfiles\Programme\PCMLizenzgenerator\PCMLizenzgenerator.exe" /PCM-Notenrechner /1.6 /E:\Inno\Setupfiles\Programme\PCMNotenrechner_x64
